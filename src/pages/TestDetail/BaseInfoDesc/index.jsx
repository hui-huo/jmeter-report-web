  ...
  return (
    <>
      <Descriptions bordered>
        <Descriptions.Item label="请求URL" span={24} labelStyle={{width: 120}}>{data.request_url}</Descriptions.Item>
        <Descriptions.Item label="请求方式" contentStyle={{width: '25%'}} >{data.request_method}</Descriptions.Item>
        <Descriptions.Item label="状态码" span={24}>{data.response_code}</Descriptions.Item>
        <Descriptions.Item label="测试结果" contentStyle={{width: '25%'}}>{data.success ? '成功' : '失败'}</Descriptions.Item>
